...
import 'package:create_social/model/conversation.dart';
import 'package:create_social/model/message.dart';
...
class FirestoreService {
  ...
  final userConversationCollection =
      FirebaseFirestore.instance.collection("user_converatoins");
  ...
  void _postUpdated(QuerySnapshot<Map<String, dynamic>> snapshot) {
